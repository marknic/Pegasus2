...
int nmea_pack_type(const char *buff, int buff_sz)
{
    ...
    static const char *pheads_glonass [] = {
        "GNGGA",
        "GNGSA",
        "GNGSV",
        "GNRMC",
    ...
    if(buff_sz < 5)
        return GPNON;
    if(0 == memcmp(buff, pheads[0], 5))
        return GPGGA;
    if(0 == memcmp(buff, pheads[1], 5))
        return GPGSA;
    if(0 == memcmp(buff, pheads[2], 5))
        return GPGSV;
    if(0 == memcmp(buff, pheads[3], 5))
        return GPRMC;
    if(0 == memcmp(buff, pheads[4], 5))
        return GPVTG;

    // GLONASS
    if (0 == memcmp(buff, pheads_glonass[0], 5))
        return GPGGA;
    if (0 == memcmp(buff, pheads_glonass[1], 5))
        return GPGSA;
    if (0 == memcmp(buff, pheads_glonass[2], 5))
        return GPGSV;
    if (0 == memcmp(buff, pheads_glonass[3], 5))
        return GPRMC;
    if (0 == memcmp(buff, pheads_glonass[4], 5))
        return GPVTG;
