...
{
public:
    GpioCtrl();  // create a GPIO object that controls GPIO4 (default
    GpioCtrl(string x); // create a GPIO object that controls GPIOx, where x is passed to this constructor
